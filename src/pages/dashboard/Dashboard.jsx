  ...
  return (
    <>
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <section className="text-center font-semibold text-gray-500">
              <a href="#" className="text-purple-600 hover:underline">Recreated on Codepen</a> with <a href="https://tailwindcss.com/" className="text-teal-400 hover:underline">Tailwind CSS</a> by Sagor, Frontend Developer
            </section>
    </>
  )
}
